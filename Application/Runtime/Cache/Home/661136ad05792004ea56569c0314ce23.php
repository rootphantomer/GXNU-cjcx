...
<html>
	...
	<body>
		...
		<div class="header">
			...
			<div class="dl-log">欢迎您，<span class="dl-log-user"><?php echo ($number); ?></span><a href="<?php echo U('loginout');?>" title="退出系统" class="dl-log-quit">[退出]</a>
			</div>
		</div>
		<div class="content">
		...
		<script>
			BUI.use('common/main',function(){
			        var config = [{id:'1',menu:[{text:'查询业务',items:[{id:'2',text:'用户信息查询',href:'getUserInfo'},{id:'3',text:'及格成绩查询',href:'getyxcj'},{id:'4',text:'不及科成绩查询',href:'getbjgcj'},{id:'6',text:'其他成绩查询',href:'getqtcj'}]}]}];
